...
#Loading models prediction
def load_mushroom_model(configs_folder,mushroom_architecture_selected,use_device):
	...
	return mushroom_model,visualizer
...
#Processing image polygons and information
def process_lab_results(image_result,averaged_length_pixels, substrate_real_size = 50):
